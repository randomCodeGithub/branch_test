...
class Bitrix
{
    ...
    {
        $url = "https://$this->domain.bitrix24.eu/rest/$this->login/$this->webhook/crm.lead.add.json";
    ...
    {
        $CRM_HOST = "$this->domain.bitrix24.eu";
    ...
    public function cf7(WPCF7_ContactForm $form)
    {
        ...
        $this->send([
            'TITLE' => 'Contact form 7 - ' . $form->title,
            'NAME' => $data['your-email'],
            'PHONE' => $this->phone($data['your-phone']),
            'EMAIL' => $this->email($data['your-email']),
